    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-options">
                <a href="{{ route('admin.shop.create') }}" class="btn btn-outline-primary btn-sm float-right"><i class="fe fe-plus mr-2"></i>Add Shop</a>
            </div>
        </div>
                ...
                <table class="table card-table table-vcenter">
                    ...
                    @foreach ($shops as $shop)
                        <tr>
                            ...
                            <td class="w-1">
                                <a class="icon" href="{{ route('admin.shop.edit', $shop->id) }}">
